...
namespace TextEditor
{
    ...
    {
        public static readonly DependencyProperty CurrentPageProperty = DependencyProperty.Register("CurrentPage", typeof(int), typeof(PrintPreviewDialog));
        ...
        private void ChangePage(int requestedPage)
        {
            ...
            if (requestedPage < 0) _pageIndex = 0;
            else if (requestedPage >= pageViewer.DocumentPaginator.PageCount) _pageIndex = pageViewer.DocumentPaginator.PageCount - 1;
